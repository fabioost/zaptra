"""
Django settings for zaptra project.
...
ALLOWED_HOSTS = ['zaptra.herokuapp.com','192.168.1.11','127.0.0.1','192.168.1.11.xip.io', 'a03bc953.ngrok.io']
...
WSGI_APPLICATION = 'zaptra.wsgi.application'
